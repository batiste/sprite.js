...
To see examples of what the framework has to offer `have a look at the test files <http://batiste.dosimple.ch/sprite.js/tests/>`_.  There is also :ref:`a list of projects that uses sprite.js <examples>`.
